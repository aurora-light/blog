...
async function generate() {
	const feed = new RSS({
		title: '睡不醒的啊轩',
		description:
			'我是睡不醒的啊轩，一名充满热情的前端开发工程师。我热衷于探索和体验最新技术，特别是人工智能（AI），并在日常工作中去使用它们，来提升我的工作效率。我的目标是积极参与开源社区，为开源项目贡献自己的力量。正如我的名字，我相信越努力，越幸运',
		site_url: 'https://dino.cn',
		feed_url: 'https://dino.cn/feed.xml'
	});
	...
	await Promise.all(
		flattenedPosts.map(async ({ file, folder }) => {
			...
			feed.item({
				...
				url: 'https://dino.cn/posts/' + file.replace(/\.mdx?/, ''),
