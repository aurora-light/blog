...
大家好，我是睡不醒的啊轩。IDEA 的 webStorm 现在免费向个人开放使用了，我之前也使用过一段时间的 webStorm，但是种种原因又转回了 VSCode 。最主要的原因是因为 webStorm 的 主题会让我看代码不舒服，而且配置低的设备会非常卡。如果你没有使用过 webStorm，可以跟我来快速上手 webStorm 进行项目开发
