...
我希望通过这篇文章来弱化我过往两年中的养成的开发习惯，全面拥抱 cursor 这类 AI 全场景覆盖的编程工具，从思维方式上来适应编程全流程都以 AI 为主的工作方式，如果你对 cursor 还不了解，请看： https://www.dino.cn/posts/post-27 ，下面来分享深度使用 cursor 后，我的一些收获
...
2. cursor 使用经验分享，满满干货：https://www.dino.cn/posts/post-27
