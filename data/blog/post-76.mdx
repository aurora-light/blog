...
大家好，我是 dino，已经和 Claude Code 结伴编程将近半年，深刻感受到终端里的 AI Agent 的强大之处，同时也更加坚定我要不断体验最新的 AI 编程产品。这不最近 chatGPT 5 发布，社区里很多人分享了 Codex 已经不输 Claude Code。看着大伙都使用上了，心里也是很着急，于是就使用这月的零花钱直接订阅了 chatGPT 和 Claude Code，我这里买的第三方服务，是共享 chatGPT pro 和 Claude Code Max 20x 。也就是当前最贵的两档大模型会员。
